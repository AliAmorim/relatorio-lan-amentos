# a53f3794-cfe4-4de5-ab29-7eeaaa5efacd implementation handoff

This archive is the source of truth for turning the design into production code. Start from `diario-de-classe-home.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `diario-de-classe-home.html`
...
- A single self-contained `diario-de-classe-home.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `diario-de-classe-home.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
## Entry points
- `diario-de-classe-home.html`
- `relatorio-frequencia-registro-aulas.html`
- `relatorio-turma.html`
...
- `agenda-semanal-spec.md`
- `drawing-2026-08-31T14-49-46-388Z.png`
- `drawing-2026-08-31T14-56-24-659Z.png`
- `figma/DESIGN-context.md`
- `figma/meta.json`
- `figma/thumbnail.png`
- `figma/tokens.json`
- `figma/tree.json`
...
1. Inspect `diario-de-classe-home.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
